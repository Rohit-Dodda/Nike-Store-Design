...
const CartItem = ({
  val: { id, title, text, img, color, shadow, rating, price, cartQuantity },
}) => {

  const dispatch = useDispatch();

  const onRemoveItem = () => {
    dispatch(setRemoveItemFromCart({id, title, text, img, color, shadow, rating, price, cartQuantity}))
  }

  const onIncreaseItemQTY = () => {
    dispatch(setIncreaseItemQTY({id, title, text, img, color, shadow, rating, price, cartQuantity}))
  }

  const onDecreaseItemQTY = () => {
    dispatch(setDecreaseItemQTY({id, title, text, img, color, shadow, rating, price, cartQuantity}))
  }
  ...
  return (
    ...
    <div className="flex items-center justify-between w-full px-5">
      <div className="flex items-center gap-5">
        ...
        <div className="grid items-center gap-4">
          ...
          <div className="flex items-center justify-around w-full">
            ...
            <span className="grid items-center  w-5 h-5 text-white stroke-[2]">-</span>
      ...
      <div className="grid items-center gap-5">
        ...
        <div className="grid items-center justify-center">
          <button type="button" onClick={onRemoveItem} className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center active:scale-110 justify-items-center cursor-pointer">
